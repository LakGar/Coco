    ...
    >
      <defs>
        <linearGradient id="rev_grad1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop
            offset="0%"
            style={{ stopColor: "#8B4513", stopOpacity: 0.8 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "#A0522D", stopOpacity: 0.6 }}
          />
        </linearGradient>
        <linearGradient id="rev_grad2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop
            offset="0%"
            style={{ stopColor: "#654321", stopOpacity: 0.9 }}
          />
          <stop
            offset="50%"
            style={{ stopColor: "#8B4513", stopOpacity: 0.7 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "#A0522D", stopOpacity: 0.6 }}
        ...
        <radialGradient id="rev_grad3" cx="50%" cy="50%" r="50%">
          <stop
            offset="0%"
            style={{ stopColor: "#6F4E37", stopOpacity: 0.8 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "#8B4513", stopOpacity: 0.4 }}
          />
        </radialGradient>
...
export const AuthComponent = ({
  ...
  return (
    <div className="bg-background min-h-screen w-screen flex flex-col">
      ...
      <div
        className={cn(
          "flex w-full flex-1 h-full items-center justify-center bg-white",
      ...
      >
        ...
        <fieldset
          ...
          className="relative z-10 flex flex-col items-center gap-8 w-full max-w-md mx-auto p-6 md:p-8"
        >
              ...
              >
                ...
                <BlurFade delay={0.25 * 5}>
                  <button
                    ...
                    className="mt-2 flex items-center gap-2 text-sm text-foreground/70 hover:text-foreground transition-colors"
                  >
          ...
          >
            <AnimatePresence>
              {authStep !== "confirmPassword" && authStep !== "verifyEmail" && (
                <motion.div
