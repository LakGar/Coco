                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setFormData({ ...formData, isPersonal: checked === true })
                    }
                  />
                  <label
                    htmlFor="isPersonal"
                  ...
                  >
                    ...
                    <span>Make this a personal task (only visible to me)</span>
                  </label>
                </div>
                <p className="text-xs text-muted-foreground mt-1 ml-6">
                  Personal tasks are only visible to you and won't appear in the
                  team's shared task list.
                </p>
              </Field>
                ...
                <FieldContent>
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                        type: value === "none" ? null : (value as TaskType),
                      })
                    }
                  >
                    <SelectTrigger>
