        ...
        <CardContent className="p-5">
          ...
          <div className="space-y-1.5">
            {displayTasks.map((task, index) => (
              <div
                key={task.id}
                className="w-full flex items-center gap-3 p-2.5 rounded-lg hover:bg-muted/50 transition-colors text-left group border border-transparent hover:border-border/50 cursor-pointer"
                tabIndex={0}
                role="button"
